  ...
  return (
    <div>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
        <div className="relative w-5/12 mx-auto my-6">
          {/*content*/}
            ...
            <div className="relative flex-auto p-6 overflow-y-auto max-h-80vh">
              <div>
                <div className="flex items-center justify-center">
                  <HiCheckCircle color="green" size={50} />
                </div>
                <div className="flex items-center justify-center font-bold text-green-700 text-xls">
                  Are You Sure Want Final This Quotation?
                </div>
              </div>
            </div>
            {/*footer*/}
