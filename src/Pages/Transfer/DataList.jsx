...
const DataList = (props) => {
  ...
  const getDetail = (transId, info) => {
    settransferId(transId);
    setinfoDetail(info);
  };
      ...
      {dataList.map((item, index) => (
        <div key={index}>
          <div className="py-3">
              ...
              <div className="flex flex-col justify-between w-9/12 ">
                <div className="p-3">
                  ...
                  <div className="flex items-center justify-start space-x-1 text-sm text-gray-500">
                    <div>
                      <BiCalendar size={15} color="#da251d" />
                    </div>
                    <div>Operating Days :</div>
                    <div className="text-teal-600">{item.operatingDays}</div>
                  </div>
                  <div className="flex items-center justify-start space-x-1 text-sm text-gray-500">
                    <div>
                    ...
                    <div className="text-teal-600">
                      {item.duration} Hours (Approximatly)
                    </div>
                  </div>
                ...
                <div className="flex mt-auto ml-2 mr-2 text-sm text-center">
                  <div
                    ...
                    ${
                      transferId === item.id && infoDetail === "description"
                        ? "bg-[#da251d]"
                        : "bg-gray-200"
                    }`}
                  ...
                  <div
                    className={`flex items-center p-2 ml-2 space-x-1 rounded-tl-sm rounded-tr-sm cursor-pointer 
                    ${
                      transferId === item.id && infoDetail === "inclution"
                        ? "bg-[#da251d]"
                        : "bg-gray-200"
                    }`}
                  ...
                  <div
                    className={`flex items-center p-2 ml-2 space-x-1 rounded-tl-sm rounded-tr-sm cursor-pointer 
                    ${
                      transferId === item.id && infoDetail === "info"
                        ? "bg-[#da251d]"
                        : "bg-gray-200"
                    }`}
                  ...
                  <div
                    className={`flex items-center p-2 ml-2 space-x-1 rounded-tl-sm rounded-tr-sm cursor-pointer 
                    ${
                      transferId === item.id && infoDetail === "mapAndstreet"
                        ? "bg-[#da251d]"
                        : "bg-gray-200"
                    }`}
            ...
            {transferId == item.id && infoDetail === "tkt" && (
